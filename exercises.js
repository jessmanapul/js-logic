...
console.log(daClub(21, 25));
console.log(daClub(20, 24));
...
console.log(graduation(124, 2.0));
console.log(graduation(116, 3.0));
console.log(graduation(100, 1.5));
...
console.log("Doughnut Price: " + doughnutPrice);
buyDoughnut();
